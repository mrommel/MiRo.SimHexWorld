...
namespace MiRo.SimHexWorld.Engine.World.Meshed
{
    ...
    /// </summary>
    public class HexagonMeshItem8X16 : IMeshObject
    {
        public enum Roughness { Plain, Hill, Peak /*, Forest*/ }
        ...
        static readonly HexagonTexture HexagonTexture = new HexagonTexture(0.05f, 0.5f, 0.95f, 0.02f, 0.27f, 0.5f, 0.73f, 0.98f, 8, 16);
        ...
        public HexagonMeshItem8X16(Vector3 pos, int index, Roughness rough = Roughness.Plain)
        {
            _pos = pos;
            _rough = rough;
