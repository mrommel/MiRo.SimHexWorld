...
{
    public class HexagonMeshItem4X4 : IMeshObject
    {
        ...
        static readonly HexagonTexture HexagonTexture = new HexagonTexture(0.1f, 0.5f, 0.9f, 0.02f, 0.27f, 0.5f, 0.73f, 0.98f, 4, 4);

        private readonly Vector3 _pos;
        readonly float[] _texturePoints;

        public HexagonMeshItem4X4(Vector3 pos, int tileX, int tileY)
        {
            _pos = pos;
        ...
        public HexagonMeshItem4X4(Vector3 pos, int index)
        {
            _pos = pos;
