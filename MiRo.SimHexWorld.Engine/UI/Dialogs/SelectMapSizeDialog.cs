...
{
    public class SelectMapSizeDialog : Dialog
    {
        ////////////////////////////////////////////////////////////////////////////    
        ...
        ////////////////////////////////////////////////////////////////////////////    
        public SelectMapSizeDialog(Manager manager)
            : base(manager)
        {
            Center();
            ...
            lstMain.Items.AddRange(Provider.Instance.MapSizes.Values.OrderBy( a => a.Order ) );
