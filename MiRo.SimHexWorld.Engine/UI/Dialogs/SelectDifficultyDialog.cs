...
{
    public class SelectDifficultyDialog : Dialog
    {
        ////////////////////////////////////////////////////////////////////////////    
        ...
        ////////////////////////////////////////////////////////////////////////////    
        public SelectDifficultyDialog(Manager manager)
            : base(manager)
        {
            Center();
            ...
            lstMain.Items.AddRange(Provider.Instance.Difficulties.Values.OrderBy( a => a.Order ) );
