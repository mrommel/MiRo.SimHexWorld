...
{
    public class SelectMapTypeDialog : Dialog
    {
        ////////////////////////////////////////////////////////////////////////////    
        ...
        ////////////////////////////////////////////////////////////////////////////    
        public SelectMapTypeDialog(Manager manager)
            : base(manager)
        {
            Center();
            ...
            lstMain.Items.AddRange(Provider.Instance.MapTypes.Values.OrderBy( a => a.Order ));
